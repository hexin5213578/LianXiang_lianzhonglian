package com.LianXiangKeJi.SupplyChain.alwaysbuy.adapter;
...
/**
 * @ClassName:AlwaysBuyAdapterOne
 * @Author:hmy
 * @Description:java类作用描述
 */
public class AlwaysBuyAdapterOne extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<Integer> list;
    private Integer integer;

    public AlwaysBuyAdapterOne(Context context, List<Integer> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.item_alwaysbuyone, null);
