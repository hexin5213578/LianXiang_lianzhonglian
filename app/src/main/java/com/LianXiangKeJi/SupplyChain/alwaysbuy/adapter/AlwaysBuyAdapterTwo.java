 ...
 */
public class AlwaysBuyAdapterTwo extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<Integer> list;
    private Integer integer;

    public AlwaysBuyAdapterTwo(Context context, List<Integer> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.item_alwaysbuytwo, null);
