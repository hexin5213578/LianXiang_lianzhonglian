 ...
 */
public class CustomDialog_ConfirmOrder extends Dialog {
    public CustomDialog_ConfirmOrder(Context context) {
        super(context);
    }

    public CustomDialog_ConfirmOrder(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public CustomDialog_ConfirmOrder create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final CustomDialog_ConfirmOrder dialog = new CustomDialog_ConfirmOrder(context, R.style.dialog_custom);
            View layout = inflater.inflate(R.layout.dialog_custom_confirmorder, null);
