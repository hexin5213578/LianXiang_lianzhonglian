...
public class OrderGoodsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<UserOrderBean.DataBean.OrdersDetailListBean> list;



    public OrderGoodsListAdapter(Context context, List<UserOrderBean.DataBean.OrdersDetailListBean> list) {
